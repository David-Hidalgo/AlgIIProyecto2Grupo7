...
public class ConsultarPreciso extends JFrame implements MouseListener{
...
*/
	...
	labelConsultar = new JLabel("Consultar");
	labelConsultar.setBounds(40,30,300,50);
	labelConsultar.setFont(new Font("Andale Mono",1,40));
	//labelConsultar.setForeground(new Color(235,235,0)); // color amarillo
	labelConsultar.setForeground(new Color(200,200,200)); // color gris
	add(labelConsultar);
